...
//
    ...
    private void InitUI() {
        ...
        try {
            ownerId = new JComboBox(tools.readLines("D:\\DataGenerator\\DataGenerator\\resources\\employees.txt"));
            ownerId.setSelectedIndex(-1);
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
            accountId = new JComboBox(tools.readLines("D:\\DataGenerator\\DataGenerator\\resources\\accounts.txt"));
            accountId.setSelectedIndex(-1);
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
            leadSource = new JComboBox(tools.readLines("D:\\DataGenerator\\DataGenerator\\resources\\leadSources.txt"));
            leadSource.setSelectedIndex(-1);
        } catch (IOException e) {
            e.printStackTrace();
        }
